...
public class GiftCertificates 
{
	 ...
	 @FindBy(xpath="//a[text()='Gift Certificates']") WebElement  giftcertificate;
	 
	 @FindBy(xpath="//input[@name='to_name']") WebElement Rname;
     
     @FindBy(xpath="//input[@name='to_email']") WebElement Remail;
     
     @FindBy(xpath="//input[@name='from_name']")  WebElement fromname;
    
     @FindBy(xpath="//input[@name='from_email']")  WebElement fromemail;
    
     @FindBy(xpath="//input[@value='6']") WebElement radio;
     
     @FindBy(xpath="//textarea[@name='message']") WebElement mssg;
     
     @FindBy(xpath="//input[@name='amount']")  WebElement amount;
